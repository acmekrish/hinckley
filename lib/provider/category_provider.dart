...
class CategoryProvider with ChangeNotifier {
  ...
  Future<void> getDressIconData() async {
    ...
    dressSnapShot.docs.forEach(
      (element) {
        dressiconData = CategoryIcon(serialNumber: element.data()["serialNumber"]);
  ...
  Future<void> getShirtIcon() async {
    ...
    shirtSnapShot.docs.forEach(
      (element) {
        shirticonData = CategoryIcon(serialNumber: element.data()["image"]);
  ...
  Future<void> getshoesIconData() async {
    ...
    shoesSnapShot.docs.forEach(
      (element) {
        shoesiconData = CategoryIcon(serialNumber: element.data()["image"]);
  ...
  Future<void> getPantIconData() async {
    ...
    pantSnapShot.docs.forEach(
      (element) {
        panticonData = CategoryIcon(serialNumber: element.data()["serialNumber"]);
  ...
  Future<void> getTieIconData() async {
    ...
    tieSnapShot.docs.forEach(
      (element) {
        tieIconData = CategoryIcon(serialNumber: element.data()["image"]);
