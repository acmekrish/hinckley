import 'package:hinckley/model/categoryicon.dart';
import 'package:hinckley/model/usermodel.dart';
import 'package:hinckley/screens/about.dart';
import 'package:hinckley/screens/checkout.dart';

import 'package:hinckley/screens/contactus.dart';
import 'package:hinckley/screens/login.dart';

import 'package:hinckley/screens/profilescreen.dart';

import '../provider/product_provider.dart';
import '../provider/category_provider.dart';
import 'package:hinckley/screens/detailscreen.dart';
import 'package:hinckley/screens/listproduct.dart';
  ...
  Widget _buildDressIcon() {
    ...
    return Row(
      ...
      return GestureDetector(
        ...
        child: _buildCategoryProduct(image: e.serialNumber, color: 0xff33dcfd),
      );
    }).toList());
  }
  ...
  Widget _buildShirtIcon() {
    ...
    return Row(
      ...
      return GestureDetector(
        ...
        child: _buildCategoryProduct(image: e.serialNumber, color: 0xfff38cdd),
      );
    }).toList());
  }
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder: (ctx) => DetailScreen(
                              image: e.serialNumber, price: e.date, name: e.name),
                        ),
                      );
                    },
                    child: SingleProduct(
